...
<p align="center">
  <img src="https://img.shields.io/badge/Agents-Reasonix%20%7C%20Claude%20Code%20%7C%20Codex%20%7C%20Gemini-0f766e" alt="Agent 支持"/>
  <img src="https://img.shields.io/badge/Reasonix-ACP%20stdio-2563eb" alt="Reasonix ACP"/>
  <img src="https://img.shields.io/badge/Channels-Telegram%20%7C%20Feishu%20%7C%20Weixin-7c3aed" alt="已验证渠道"/>
</p>
...
- **新增 Agent** — 支持 Kimi CLI、Pi agent 和 **Reasonix**。Reasonix 通过 ACP stdio 运行，复用现有平台层。*[接入说明 → `docs/reasonix.zh-CN.md`](docs/reasonix.zh-CN.md)*
...
### 🤖 通用 Agent 支持
**10+ 大 AI Agent** — Claude Code、Codex、Cursor Agent、Kimi CLI、Qoder CLI、Gemini CLI、OpenCode、iFlow CLI、Pi、Devin、**Reasonix**，还可通过 [Agent Client Protocol (ACP)](https://agentclientprotocol.com/get-started/agents) 接入更多 Agent。按需选用，或同时使用全部。
...
| Agent | Qoder CLI | ✅ 已支持 |
| Agent | Reasonix | ✅ 已支持（通过 ACP）— [指南](docs/reasonix.zh-CN.md) |
...
| Agent | 指南 | 运行方式 |
|-------|------|----------|
| Reasonix | [docs/reasonix.zh-CN.md](docs/reasonix.zh-CN.md) | ACP stdio (`reasonix acp`) |
...
- [Reasonix Agent 接入指南](docs/reasonix.zh-CN.md) — 通过 ACP stdio 接入 DeepSeek-native Reasonix
