...
### 🤖 通用 Agent 支持
**10+ 大 AI Agent** — Claude Code、Codex、Cursor Agent、Kimi CLI、Grok Build（原生 CLI，不经 ACP）、Qoder CLI、Gemini CLI、OpenCode、iFlow CLI、Pi、Devin、Copilot，还可通过 [Agent Client Protocol (ACP)](https://agentclientprotocol.com/get-started/agents) 接入更多 Agent。按需选用，或同时使用全部。
...
| Agent | Grok Build (xAI) | ✅ 原生 CLI（非 ACP） |
