...
func TestResolveMaxAttachmentSize(t *testing.T) {
	...
	t.Setenv("CC_MAX_ATTACHMENT_SIZE", "")
	...
	// Env var (raw bytes) takes precedence over config.
	t.Setenv("CC_MAX_ATTACHMENT_SIZE", strconv.FormatInt(1<<30, 10))
