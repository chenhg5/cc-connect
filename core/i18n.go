...
var messages = map[MsgKey]map[Language]string{
	...
	MsgReceiptViewOriginal: {
		...
		LangChinese:            "展开原信",
		LangTraditionalChinese: "展開原信",
		LangJapanese:           "原文を表示",
		LangSpanish:            "Ver original",
	},
	MsgReceiptCollapse: {
		LangEnglish:            "Collapse",
		LangChinese:            "收起",
		LangTraditionalChinese: "收起",
		LangJapanese:           "折りたたむ",
		LangSpanish:            "Contraer",
	},
	MsgReceiptReceive: {
		LangEnglish:            "✅ Receive",
		LangChinese:            "✅ 收件",
	...
	MsgHelpSystemSection: {
		LangEnglish: "**System**\n" +
			...
			"/mail — Active letter inbox (INDEX, zero AI)\n" +
		...
		LangSpanish: "**Sistema**\n" +
			...
			"/mail — Bandeja de cartas activas (INDEX, sin AI)\n" +
	...
	MsgBuiltinCmdMail: {
		LangEnglish:            "List active letters from INDEX (zero AI), args: [--thread <slug>] [--since MM-DD]",
		LangChinese:            "从 INDEX 列出活跃信件（零 AI），参数: [--thread <slug>] [--since MM-DD]",
		LangTraditionalChinese: "從 INDEX 列出活躍信件（零 AI），參數: [--thread <slug>] [--since MM-DD]",
		LangJapanese:           "INDEX からアクティブ手紙を表示（AIなし）、引数: [--thread <slug>] [--since MM-DD]",
		LangSpanish:            "Listar cartas activas del INDEX (sin AI), args: [--thread <slug>] [--since MM-DD]",
	},
	MsgMailNoArchive: {
		LangEnglish:            "📬 No letter archive configured. Set notify_index_path or data_dir.",
		LangChinese:            "📬 未配置信件归档路径。请设置 notify_index_path 或 data_dir。",
		LangTraditionalChinese: "📬 未設定信件歸檔路徑。請設定 notify_index_path 或 data_dir。",
		LangJapanese:           "📬 手紙アーカイブが未設定です。notify_index_path または data_dir を設定してください。",
		LangSpanish:            "📬 Archivo de cartas no configurado. Define notify_index_path o data_dir.",
	},
	MsgMailUnreadable: {
		LangEnglish:            "📬 Cannot read INDEX: %s",
		LangChinese:            "📬 无法读取 INDEX: %s",
		LangTraditionalChinese: "📬 無法讀取 INDEX: %s",
		LangJapanese:           "📬 INDEX を読めません: %s",
		LangSpanish:            "📬 No se puede leer INDEX: %s",
	},
	MsgMailUsageError: {
		LangEnglish:            "📬 /mail usage error: %s\nUsage: /mail [--thread <slug>] [--since MM-DD]",
		LangChinese:            "📬 /mail 参数错误: %s\n用法: /mail [--thread <slug>] [--since MM-DD]",
