...
const (
	...
	MsgCdChanged      MsgKey = "cd_changed"
	MsgCdCurrent      MsgKey = "cd_current"
	MsgCdUsage        MsgKey = "cd_usage"
...
var messages = map[MsgKey]map[Language]string{
	...
	MsgHelpToolsSection: {
		LangEnglish: "**Tools & Automation**\n" +
			...
			"/cd [path] — Show or switch work directory\n" +
		...
		LangSpanish: "**Herramientas y automatización**\n" +
			...
			"/cd [ruta] — Ver o cambiar directorio de trabajo\n" +
	...
	MsgBuiltinCmdCd: {
		LangEnglish:            "Switch agent working directory, arg: <path>",
		LangChinese:            "切换 Agent 工作目录，参数: <路径>",
		LangTraditionalChinese: "切換 Agent 工作目錄，參數: <路徑>",
		LangJapanese:           "エージェントの作業ディレクトリを変更、引数: <パス>",
		LangSpanish:            "Cambiar directorio de trabajo del agente, arg: <ruta>",
	},
	MsgCdChanged: {
	...
	MsgCdUsage: {
		LangEnglish:            "Usage: `/cd <path>`\nExample: `/cd ../project`",
		LangChinese:            "用法: `/cd <路径>`\n示例: `/cd ../project`",
		LangTraditionalChinese: "用法: `/cd <路徑>`\n範例: `/cd ../project`",
		LangJapanese:           "使い方: `/cd <パス>`\n例: `/cd ../project`",
		LangSpanish:            "Uso: `/cd <ruta>`\nEjemplo: `/cd ../project`",
	},
	MsgCdNotSupported: {
